    ...
    render(){
        ...
        <div>
            <div className = "row">
                ...
                <div className = "justify-content-center align-items-center p50 col-4"><button id = "topRight" onClick = {()=>{var nextTurn = this.state.turn == "x" ? "o":"x"; this.setState({topRight:this.state.turn, turn:nextTurn})}}  className = "p50 bg-transparent border-0 fullFont" >{this.state.topRight}</button></div>
            </div>
            <div className = "row">
